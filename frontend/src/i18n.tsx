...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "filters.searchParent": "Search parent",
    ...
    "drawer.buttons.alignment": "Alignment View",
    "drawer.buttons.openParent": "Open Parent",
  ...
  zh: {
    ...
    "app.orgLabel": "组织",
    "app.languageButton": "中/EN",
    "app.notifications": "提醒",
    "app.noNotifications": "暂无提醒",
    "app.untitledTodo": "未命名",
    "app.read": "已读",
    "app.unread": "未读",
    ...
    "drawer.buttons.alignment": "对齐视图",
    "drawer.buttons.openParent": "父级",
